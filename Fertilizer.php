...
<div class="header">
	 ...
	 <br>
	  <div class="header-right">
	   ...
	   <div class="subnav">
		   <button style="font-size: 25px;" class="subnavbtn"><a style="font-size: 25px;" href="weatherwebsite/index.php">Weather</a><i class="#"></i></button>
		   <div class="subnav-content">
		   <li><a style="font-size: 25px;" href="weatherwebsite/currentLocationW/index.php">Your Current Location</a></li>
		   </div>
	   </div>
	   <a style="font-size: 25px;" href="govts.php">Goverment Schemes</a>   
	   <div class="subnav">
