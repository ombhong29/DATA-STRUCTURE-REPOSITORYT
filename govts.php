	...
	<div class="header">
	 ...
	 <br>
	  <div class="header-right">
	   ...
	   <div class="subnav" >
		   <a style="font-size: larger;float: left;color: white;text-align: center;padding: 12px;text-decoration: none;font-size: 18px;line-height: 25px;border-radius: 4px; padding-top: 1px" href = "weatherwebsite/index.php">Weather</a>
