...
<section id="gallery" >
  <div class="container">
   ...
   <div class="gallery_main_2 clearfix">
    ...
    <div class="gallery_1">
                  <!-- normal -->
                  <div class="ih-item square effect15 left_to_right"><a href="#1">
    ...
    <div class="gallery_1">
                  <!-- normal -->
                  <div class="ih-item square effect15 left_to_right"><a href="#2">
   ...
   <div class="col-sm-4 padding_all">
    ...
    <div class="gallery_1">
                  <!-- normal -->
                  <div class="ih-item square effect15 left_to_right"><a href="#3">
   ...
   <div class="col-sm-4 padding_all">
    ...
    <div class="gallery_1">
                  <!-- normal -->
                  <div class="ih-item square effect15 left_to_right"><a href="#4">
   ...
   <div class="col-sm-4 padding_all">
    ...
    <div class="gallery_1">
                  <!-- normal -->
                  <div class="ih-item square effect15 left_to_right"><a href="#5">
   ...
   <div class="col-sm-4 padding_all">
    ...
    <div class="gallery_1">
                  <!-- normal -->
                  <div class="ih-item square effect15 left_to_right"><a href="#6">
   ...
   <div class="col-sm-4 padding_all">
    <div class="centered8"> 
        <div class="gallery_1">
                  <!-- normal -->
                  <div class="ih-item square effect15 left_to_right"><a href="#7">
...
<h2 id = "1">Types of Wheat Seed </h2>
...
<h2 id = "2">Types of Maize Seed</h2>
...
<div class="header">
<h2 id = "5">Types Of Coffees</h2>
</div>
<img src="images/5.jpeg" alt="Tea Plant" align="Right" height=550px width=550px>
...
<div class="header">
<h2 id = "6">Types of Teas</h2>
</div>
<img src="images/6.jpeg" alt="Tea Plant"align="Right" height=350px width=650px>
<div class ="boxx">
