	 ...
	 <br>
	  <div class="header-right">
       ...
       <button style="font-size: 20px;" class="subnavbtn"><a href ="login2.php">Log in</a><i class="#" ></i></button>
		   ...
		   <button style="font-size: 20px;" class="subnavbtn"><a href ="registration2.php">Register</a><i class="#" ></i></button>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="welcome-single-services">
					...
					<div class="text-box">
						<div class="content">
							<h3><a style="font-size: 20px;" href="https://blynk.cloud/dashboard/272713/global/devices/1888491/organization/272713/devices/996695/dashboard">IOT</a></h3>
