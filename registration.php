...
<header>
    ...
    ?>
      <form method="post" id="register" action="registration_db.php">  
    <img src="https://coffeelogin.netlify.app/assets/person.jpg" class="avatar" alt="img">
        <h1>Register Yourself</h1>
<div>
    <label>Full Name</label>
    <input type="text" name="full_name" id="full_name" placeholder="Enter First Name" required>
</div>
<br>
<div>
    <label>Username</label>
    <input type="text" name="username" id="username" placeholder="Enter Last Name" required>
</div>
<br>
<div>
