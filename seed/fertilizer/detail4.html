	   ...
	   <div class="blog_home1i clearfix">
	    <div class="grid clearfix">
		  <figure class="effect-jazz">
			<a href="#"><img src="img/i4.jpeg" class="iw mgt" alt="img25" height="600px" width="300px"></a>
		  </figure>
	  </div>
  ...
  <div class="row">
   <div class="col-sm-12">
    <div class="footer_main_1">
	 <h2>Developed By Team GoAgro</h2>
	 <ul>
...
<section id="footer">
 <div class="container">
  <div class="row">
   <div class="col-sm-12">
	...
	<div class="col-sm-6">
	 <div class="footer_4" >
	  ...
	  <ul>
		   <li>MAIL : <a href="#"> teamgoagro@gmail.com</a></li>
	  </ul>
	 </div>
	</div>
   </div>
   <div class="col-sm-12">
    <div class="footer_5">
	 <p>  GOAGRO-ALL YOU NEED FOR AGRONOMY . All Rights Reserved | Design by Team GoAgro</p>
	</div>   
   </div>
  </div>
 </div>
