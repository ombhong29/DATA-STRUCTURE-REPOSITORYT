...
const userMessage = [
  ...
  /* 18 */["What's the time now?", "What's the current time?", "Tell me the time", "time"],
    /* 19 */["events", "news", "plans", "esports", "game", "planned", "future"],
        ...
        /* 21 */["what is farm?", "farm", "farmer?"],
        /* 22 */["what is meant by pestisides?", "use of pestisides", "types of pestisides?"],
];
...
const botReply = [
  ...
  /* 6 */["AgroTech is my creator 🙌"],
  /* 7 */["You can contact AgroTech:<br> Email: <a href='mailto:AgroTech20085@gmail.com'>AgroTech20085@gmail.com 📧</a>"],
  /* 8 */["You can contact AgroTech:<br> Phone: <a href='tel:7448094635'>7448094635</a> 📱<br> WhatsApp: <a href='https://wa.me/7448094635'>7448094635</a> 💬"],
  /* 9 */["Instagram: <a href='https://www.instagram.com/AgroTech/'>@AgroTech 📷</a>"],
  /* 10 */["chatbot: <a href='AgroTech20085@gmail.com'>@AgroTech 🐙</a>"],
  /* 11 */["I am chatbot by AgroTech 😊"],
  /* 12 */["I love you too ❤️", "Me too! 😄", "Thanks! Try giving feedback on WhatsApp: <a href='https://wa.me/7448094635'>7448094635</a> 💬"],
  /* 13 */[
    "I'm glad to hear that you're feeling happy! 😄", "That's great! 😊", "Thanks! Try giving feedback on WhatsApp: <a href='https://wa.me/7353346164'>7448094635</a> 💬", "Fun is always good! 🎉", "Wonderful! 😄", "Fantastic! 😃", "Cool! 😎", "😊", "Awesome! 🌟", "Excellent! 👏"
  ],
  /* 14 */[
...
/* 20 */[
  ...
  /* 21 */[
    "farm is an area of land that is devoted primarily to agricultureal process with primary objective of producing food and other crops 🏫🤝",
    "farmer is a person who runs and works on a farm 📚🤝",
    "Ah,is used to growing plats and keeping animals 🌟🤝"
  ],
  /* 22 */[
    "Any substance or mixture of substances intended for preventing, destroying, repelling, or mitigating any pest. 🧪☣️☠️⚗️🤢 | 🥔☣️",
    "Pesticides are used to control various pests and disease carriers, such as mosquitoes, ticks, rats and mice. Pesticides are used in agriculture to control weeds, insect infestation and diseases.🥔☣️",
    "Insecticides – insects.Herbicides – plants Rodenticides – rodents (rats & mice) Bactericides – bacteria. Fungicides – fungi.Larvicides – larvae."
  ],
];
...
const alternative = [
  ...
  "You can contact AgroTech:<br> Phone: <a href='tel:7448094635'>7448094635 📱</a><br> WhatsApp: <a href='https://wa.me/7448094635'>7448094635 💬"
];
let lastUserDiv;
